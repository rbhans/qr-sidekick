# QRBAS - Agent Instructions

## Project Overview

QRBAS is a self-hosted Go server and browser PWA for BAS technicians. This repo now contains only the server, embedded PWA, and static marketing site.
